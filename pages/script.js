...
// fetch("/pages/admin/data/news.json").then(response => response.json())
//     .then(data => {
//         let dat = ``;
...
// fetch("/pages/admin/data/donations.json").then(response => response.json())
//     .then(data => {
//         let dat = ``;
//         for(let item of data){
//             dat += ` <li>
...
//     fetch("/pages/admin/data/events.json").then(response => response.json())
//     .then(data => {
//         let dat = ``;
//         for(let item of data){
...
//homepage alumni carousel
  fetch('./pages/admin/data/alumnicarousel.json')
  .then((r) => r.json())
  .then((d) => {
  ...
  fetch('./pages/admin/data/homeMainCarousel.json')
  .then((r) => r.json())
  .then((d) => {
