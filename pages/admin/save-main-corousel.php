...
if($_POST['image'] != '' && $_POST['serial'] != ''){
	
	if(file_exists('data/homeMainCarousel.json')){

		$current_data = file_get_contents('data/homeMainCarousel.json');
		...
		if(file_put_contents('data/homeMainCarousel.json', $json_data))
		{
